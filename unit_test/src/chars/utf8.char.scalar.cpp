...
namespace
{
	GAL_PROMETHEUS_COMPILER_NO_DESTROY unit_test::suite<"chars.utf8.char.scalar"> _ = []
	{
		...
		{
			"to_latin"_test = [source = make_random_utf8_char_string_ascii_only()]
			{
				expect(Scalar<"utf8.char">::validate<true>(source) == "valid utf8_char string"_b) << required;
				expect(Scalar<"utf8.char">::length<CharsType::LATIN>(source) == value(source.size())) << required;
				...
				using output_type = std::basic_string<char>;
				{
					...
					expect(dest == Scalar<"utf8.char">::convert<CharsType::LATIN>(source)) << required;
				}
				{
					output_type dest{};
					dest.resize(Scalar<"utf8.char">::length<CharsType::LATIN>(source));
					...
					expect(dest == Scalar<"utf8.char">::convert<CharsType::LATIN, InputProcessPolicy::ASSUME_VALID_INPUT>(source)) << required;
				}
			};

			"to_utf8_char"_test = [source = make_random_utf8_char_string()]
			{
				expect(Scalar<"utf8.char">::validate<true>(source) == "valid utf8_char string"_b) << required;
				expect(Scalar<"utf8.char">::length<CharsType::UTF8_CHAR>(source) == value(source.size())) << required;
				...
				using output_type = std::basic_string<char>;
				{
					...
					expect(dest == Scalar<"utf8.char">::convert<CharsType::UTF8_CHAR>(source)) << required;
				}
				{
					output_type dest{};
					dest.resize(Scalar<"utf8.char">::length<CharsType::UTF8_CHAR>(source));
					...
					expect(dest == Scalar<"utf8.char">::convert<CharsType::UTF8_CHAR, InputProcessPolicy::ASSUME_VALID_INPUT>(source)) << required;
				}
			};

			"to_utf8"_test = [source = make_random_utf8_char_string()]
			{
				expect(Scalar<"utf8.char">::validate<true>(source) == "valid utf8_char string"_b) << required;
				expect(Scalar<"utf8.char">::length<CharsType::UTF8>(source) == value(source.size())) << required;
				...
				using output_type = std::basic_string<char8_t>;
				{
					...
					expect(dest == Scalar<"utf8.char">::convert<CharsType::UTF8>(source)) << required;
				}
				{
					output_type dest{};
					dest.resize(Scalar<"utf8.char">::length<CharsType::UTF8>(source));
					...
					expect(dest == Scalar<"utf8.char">::convert<CharsType::UTF8, InputProcessPolicy::ASSUME_VALID_INPUT>(source)) << required;
				}
			};

			"to_utf16_le"_test = [source = make_random_utf8_char_string()]
			{
				expect(Scalar<"utf8.char">::validate<true>(source) == "valid utf8_char string"_b) << required;
				...
				using output_type = std::basic_string<char16_t>;
				{
					...
					expect(dest == Scalar<"utf8.char">::convert<CharsType::UTF16_LE>(source)) << required;
				}
				{
					output_type dest{};
					dest.resize(Scalar<"utf8.char">::length<CharsType::UTF16_LE>(source));
					...
					expect(dest == Scalar<"utf8.char">::convert<CharsType::UTF16_LE, InputProcessPolicy::ASSUME_VALID_INPUT>(source)) << required;
				}
			};

			"to_utf16_be"_test = [source = make_random_utf8_char_string()]
			{
				expect(Scalar<"utf8.char">::validate<true>(source) == "valid utf8_char string"_b) << required;
				...
				using output_type = std::basic_string<char16_t>;
				{
					...
					expect(dest == Scalar<"utf8.char">::convert<CharsType::UTF16_BE>(source)) << required;
				}
				{
					output_type dest{};
					dest.resize(Scalar<"utf8.char">::length<CharsType::UTF16_BE>(source));
					...
					expect(dest == Scalar<"utf8.char">::convert<CharsType::UTF16_BE, InputProcessPolicy::ASSUME_VALID_INPUT>(source)) << required;
				}
			};

			"to_utf32"_test = [source = make_random_utf8_char_string()]
			{
				expect(Scalar<"utf8.char">::validate<true>(source) == "valid utf8_char string"_b) << required;
				...
				using output_type = std::basic_string<char32_t>;
				{
					...
					expect(dest == Scalar<"utf8.char">::convert<CharsType::UTF32>(source)) << required;
				}
				{
					output_type dest{};
					dest.resize(Scalar<"utf8.char">::length<CharsType::UTF32>(source));
					...
					expect(dest == Scalar<"utf8.char">::convert<CharsType::UTF32, InputProcessPolicy::ASSUME_VALID_INPUT>(source)) << required;
				}
			};
		}
	};
