...
constexpr auto make_test_detect_encoding() noexcept -> void
{
	using namespace gal::prometheus::unit_test;
	...
	"UTF8"_test = []
	{
		...
		{
				// 你好,世界!
				0xe4, 0xbd, 0xa0, 0xe5, 0xa5, 0xbd, 0x2c, 0xe4, 0xb8, 0x96, 0xe7, 0x95, 0x8c, 0x21, 0x20,
				// Привет! 
				0xd0, 0x9f, 0xd1, 0x80, 0xd0, 0xb8, 0xd0, 0xb2, 0xd0, 0xb5, 0xd1, 0x82, 0x21, 0x20,
				// 😀
				0xf0, 0x9f, 0x98, 0x80, 0x20,
				// Hello, world!
				0x48, 0x65, 0x6c, 0x6c, 0x6f, 0x2c, 0x20, 0x77, 0x6f, 0x72, 0x6c, 0x64, 0x21, 0x20,
				// 我 am utf-8
				0xe6, 0x88, 0x91, 0x20, 0x61, 0x6d, 0x20, 0x75, 0x74, 0x66, 0x2d, 0x38, 0x20,
				// 你好 🌍!
				0xe4, 0xbd, 0xa0, 0xe5, 0xa5, 0xbd, 0x20, 0xf0, 0x9f, 0x8c, 0x8d, 0x21, 0x20,
				// 123
				0x31, 0x32, 0x33
		};
		constexpr auto result = chars::EncodingType::UTF8;
		...
		const auto encoding = Impl::encoding_of(source);
		expect(encoding == value(result));
	};
	...
	"UTF16"_test = []
	{
		...
		constexpr auto result = chars::EncodingType::UTF16_LE;
	...
	"UTF32"_test = []
	{
		...
		constexpr auto result = chars::EncodingType::UTF32_LE;
	...
	"ALL"_test = []
	{
		...
		constexpr auto result = static_cast<chars::EncodingType>(
			std::to_underlying(chars::EncodingType::UTF8) |
			std::to_underlying(chars::EncodingType::UTF16_LE) |
			std::to_underlying(chars::EncodingType::UTF32_LE)
		);
	...
	"ERROR"_test = []
	{
		...
		constexpr auto result = chars::EncodingType::UNKNOWN;
