		...
		for (std::size_t i = 0; i < trials; ++i)
		{
			"to_latin"_test = [source = make_random_latin_string_ascii_only()]
			{
				...
				using output_type = std::basic_string<char>;
				{
					...
					expect(valid == "valid latin string"_b) << required;

					const auto result = Scalar<"latin">::convert<CharsType::LATIN>(source);
					expect(dest == ref(result)) << required;
				}
				{
					output_type dest{};
					dest.resize(output_length);
			...
			"to_utf8_char"_test = [source = make_random_latin_string()]
			{
				// expect(Scalar<"latin">::validate<true>(source) == "valid latin string"_b) << required;
				...
				using output_type = std::basic_string<char>;
				{
					...
					expect(valid == "valid utf8_char string"_b) << required;
			...
			"to_utf8"_test = [source = make_random_latin_string()]
			{
				// expect(Scalar<"latin">::validate<true>(source) == "valid latin string"_b) << required;
				...
				using output_type = std::basic_string<char8_t>;
				{
					...
					expect(valid == "valid utf8 string"_b) << required;
			...
			"to_utf16_le"_test = [source = make_random_latin_string()]
			{
				// expect(Scalar<"latin">::validate<true>(source) == "valid latin string"_b) << required;
				...
				using output_type = std::basic_string<char16_t>;
				{
					...
					expect(valid == "valid utf16_le string"_b) << required;
			...
			"to_utf16_be"_test = [source = make_random_latin_string()]
			{
				// expect(Scalar<"latin">::validate<true>(source) == "valid latin string"_b) << required;
				const auto output_length = Scalar<"latin">::length<CharsType::UTF16>(source);
				...
				using output_type = std::basic_string<char16_t>;
				{
					...
					expect(valid == "valid utf16_be string"_b) << required;
			...
			"to_utf32"_test = [source = make_random_latin_string()]
			{
				// expect(Scalar<"latin">::validate<true>(source) == "valid latin string"_b) << required;
				...
				using output_type = std::basic_string<char32_t>;
				{
					...
					expect(valid == "valid utf32 string"_b) << required;
