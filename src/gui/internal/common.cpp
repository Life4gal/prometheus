...
namespace gal::prometheus::gui::internal
{
	...
	PrimitiveAppender::PrimitiveAppender(
	...
	auto PrimitiveAppender::vertex_count() const noexcept -> size_type
	{
	...
	auto PrimitiveAppender::reserve(const size_type vertex_count, const size_type index_count) noexcept -> void
	{
	...
	auto PrimitiveAppender::reserve(const std::size_t vertex_count, const std::size_t index_count) noexcept -> void
	{
		reserve(static_cast<size_type>(vertex_count), static_cast<size_type>(index_count));
	}

	auto PrimitiveAppender::add_vertex(const point_type& point, const uv_type& uv, const color_type color) noexcept -> void
	{
	...
	auto PrimitiveAppender::add_index(const index_type a, const index_type b, const index_type c) noexcept -> void
	{
