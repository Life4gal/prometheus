...
GAL_PROMETHEUS_COMPILER_MODULE_NAMESPACE_EXPORT(meta)
{
	...
	template<typename T>
	using basic_char_array_view = GAL_PROMETHEUS_COMPILER_MODULE_INTERNAL::default_view<T>;
	...
	template<typename T>
	using basic_fixed_string_view = GAL_PROMETHEUS_COMPILER_MODULE_INTERNAL::default_view<T>;
	...
	template<typename T, T... Cs>
	struct basic_char_array : GAL_PROMETHEUS_COMPILER_MODULE_INTERNAL::meta_string_base<basic_char_array<T, Cs...>, T, std::size_t>
	{
		using base_type = GAL_PROMETHEUS_COMPILER_MODULE_INTERNAL::meta_string_base<basic_char_array, T, std::size_t>;
	...
	template<typename T, std::size_t N>
	struct basic_fixed_string : GAL_PROMETHEUS_COMPILER_MODULE_INTERNAL::meta_string_base<basic_fixed_string<T, N>, T, std::size_t>
	{
		using base_type = GAL_PROMETHEUS_COMPILER_MODULE_INTERNAL::meta_string_base<basic_fixed_string, T, std::size_t>;
	...
	basic_fixed_string(basic_char_array<T, Cs...> char_array) -> basic_fixed_string<
		T,
		// DO NOT USE `basic_char_array<T, Cs...>::size`!
		sizeof...(Cs) - GAL_PROMETHEUS_COMPILER_MODULE_INTERNAL::contains_zero<T, Cs...>()
	>;
