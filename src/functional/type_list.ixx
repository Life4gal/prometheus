...
GAL_PROMETHEUS_COMPILER_MODULE_NAMESPACE_INTERNAL(functional)::type_list_detail
{
...
GAL_PROMETHEUS_COMPILER_MODULE_NAMESPACE_EXPORT(functional)
{
	...
	template<typename T>
	concept type_list_t = GAL_PROMETHEUS_COMPILER_MODULE_INTERNAL::type_list_detail::list_t<T>;
