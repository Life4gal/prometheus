...
#endif
{
	...
	private:
		...
		constexpr static auto do_invoke_function(data_type data, Args... args) //
			noexcept(noexcept(
		...
		constexpr static auto do_invoke_functor(data_type data, Args... args) //
			noexcept(noexcept(
		...
		constexpr FunctionRef(constructor_tag, FunctionPointer function) noexcept
			: data_{data_type::constructor_tag<function_pointer>{}, reinterpret_cast<function_pointer>(function)},
			  ...
			  invoker_{&do_invoke_function<typename GAL_PROMETHEUS_COMPILER_MODULE_INTERNAL::compatible_function_pointer<FunctionPointer>::type>}
		{
			// throw exception?
	...
	public:
		template<typename FunctionPointer>
			requires GAL_PROMETHEUS_COMPILER_MODULE_INTERNAL::compatible_function_pointer<FunctionPointer>::template value<Return, Args...> //
		...
		template<typename StatelessLambda>
			requires(not GAL_PROMETHEUS_COMPILER_MODULE_INTERNAL::compatible_function_pointer<StatelessLambda>::template value<Return, Args...>) and
		 ...
		 */
		template<typename Functor>
			requires(not GAL_PROMETHEUS_COMPILER_MODULE_INTERNAL::compatible_function_pointer<Functor>::template value<Return, Args...>) and
