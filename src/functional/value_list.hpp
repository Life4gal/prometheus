...
namespace gal::prometheus::functional
{
	...
	template<auto... Values>
	struct value_list_type : value_list_detail::list<Values...> {};

	template<auto... Values>
	constexpr auto value_list = value_list_type<Values...>{};

	template<typename T>
	struct is_value_list : value_list_detail::is_list<T> {};

	template<typename T>
	constexpr auto is_value_list_v = value_list_detail::is_list_v<T>;

	template<typename T>
	concept value_list_t = value_list_detail::list_t<T>;

	template<char... Cs>
	struct char_list_type : value_list_detail::char_list<Cs...> {};

	template<char... Cs>
	constexpr auto char_list = char_list_type<Cs...>{};

	template<typename T>
	struct is_char_list : value_list_detail::is_char_list<T> {};

	template<typename T>
	constexpr auto is_char_list_v = value_list_detail::is_char_list_v<T>;
