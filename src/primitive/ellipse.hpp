...
namespace gal::prometheus
{
	namespace primitive
	{
				...
				: meta::dimension<basic_ellipse<2, PointValueType, RadiusValueType, RotationValueType>>
		{
			...
			// warning: missing initializer for member ‘gal::prometheus::primitive::basic_ellipse<2, float>::<anonymous>’ [-Wmissing-field-initializers]
			// {.point = point, .radius = radius, .rotation = rotation};
			//                                                                                    ^
			// No initialization value specified for base class `meta::dimension`
			constexpr basic_ellipse() noexcept
				: point{},
				  radius{radius},
				  rotation{} {}

			constexpr basic_ellipse(const point_type point, const radius_type radius, const rotation_value_type rotation = rotation_value_type{0}) noexcept
				: point{point},
				  radius{radius},
				  rotation{rotation} {}
	...
	namespace meta
	{
		// This makes `ellipse1 == ellipse2` return a boolean instead of array<bool, N>
		template<std::size_t N, typename PointValueType, typename RadiusValueType, typename RotationValueType>
		struct dimension_folder<primitive::basic_ellipse<N, PointValueType, RadiusValueType, RotationValueType>, DimensionFoldOperation::EQUAL>
		{
		...
		// This makes `ellipse1 != ellipse2` return a boolean instead of array<bool, N>
		template<std::size_t N, typename PointValueType, typename RadiusValueType, typename RotationValueType>
		struct dimension_folder<primitive::basic_ellipse<N, PointValueType, RadiusValueType, RotationValueType>, DimensionFoldOperation::NOT_EQUAL>
		{
